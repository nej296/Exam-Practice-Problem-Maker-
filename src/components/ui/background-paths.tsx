...
export function BackgroundPaths({ children }: { children?: React.ReactNode }) {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-start justify-center pt-[12vh] overflow-hidden bg-white">
        ...
        >
          {children ?? (
            <div className="flex flex-col gap-6 items-center">
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-neutral-900">
